...
CreateReportStructure = function(evaluation, presentation.model){
  ...
  item1 = list(label = "", value = paste0("This report was generated by ", presentation.model$project$username, " using the Mediana package version ",packageVersion("Mediana"),". For more information about the Mediana package, see http://gpaux.github.io/Mediana."))
