...
For more information about the `Test` object, see the package's documentation [Test](http://cran.r-project.org/package=Mediana/Mediana.pdf) on the CRAN web site.
