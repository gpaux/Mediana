...
If the user is interested in generate graphical summaries of the simulation results (using the the [ggplot2](https://ggplot2.tidyverse.org/) package or other packages), this data frame can also be saved to an object:
