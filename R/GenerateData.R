...
#' \code{sim.parameters} object.} \item{data.data.scenario.grid }{a data frame
#' indicating all data scenario according to the \code{DataModel} object.}
#' \item{data.structure }{a list containing the data structure according to the
#' \code{DataModel} object.} \item{sim.parameters }{a list containing the
#' simulation parameters according to \code{SimParameters} object.}
